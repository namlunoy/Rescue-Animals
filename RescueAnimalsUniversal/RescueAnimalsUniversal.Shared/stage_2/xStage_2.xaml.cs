...
namespace RescueAnimalsUniversal.stage_2
{
    ...
    /// </summary>
    public sealed partial class xStage_2 : Page
    {
        ...
        public xStage_2()
        {
            ...
            StaticObjects.currentUser.ListPoint[1] = 0;
            score.Text = StaticObjects.currentUser.ListPoint[1].ToString();
        }
            ...
            if (f != null && g != null)
            {
                ...
                if (a != null && b != null)
                {
                    if (a.Equals(b))
                    {
                        ...
                        StaticObjects.currentUser.ListPoint[1]++;
                    }
        ...
        private async Task ShowFinishAsync()
        {
            ...
            isStop = true;
            txtHuongDan.Text = "Your point is " + StaticObjects.currentUser.ListPoint[1];

            int k = StaticObjects.stageControll.ListStage[1].TinhSao(StaticObjects.currentUser.ListPoint[1]);
            for (int i = 1; i <= k; i++)
            {
                Image x = new Image();
                x.Height = 100;
