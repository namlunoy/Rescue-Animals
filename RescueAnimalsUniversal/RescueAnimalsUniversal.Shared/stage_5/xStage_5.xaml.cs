...
namespace RescueAnimalsUniversal.stage_5
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class xStage_5 : Page
    {
        ...
        public xStage_5()
        {
            ...
            StaticObjects.currentUser.ListPoint[4] = 0;
            score.Text = StaticObjects.currentUser.ListPoint[4].ToString();
        }
            ...
            if (f != null && g != null)
            {
                ...
                if (a != null && b != null)
                {
                    if (a.Equals(b))
                    {
                        ...
                        StaticObjects.currentUser.ListPoint[4]++;
                    }
        ...
        private async Task ShowFinishAsync()
        {
            ...
            isStop = true;
            txtHuongDan.Text = "Your point is " + StaticObjects.currentUser.ListPoint[4];

            int k = StaticObjects.stageControll.ListStage[4].TinhSao(StaticObjects.currentUser.ListPoint[4]);
            for (int i = 1; i <= k; i++)
            {
                Image x = new Image();
                x.Height = 100;
